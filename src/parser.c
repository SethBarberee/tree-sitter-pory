...
enum ts_symbol_identifiers {
  ...
  anon_sym_LBRACE = 2,
  anon_sym_RBRACE = 3,
  sym_text_block_type = 4,
  aux_sym_block_type_token1 = 5,
  aux_sym_block_type_token2 = 6,
  aux_sym_block_type_token3 = 7,
  aux_sym_block_type_token4 = 8,
  anon_sym_LPAREN = 9,
  anon_sym_RPAREN = 10,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_text_block_type] = ACTIONS(7),
    [aux_sym_block_type_token1] = ACTIONS(9),
    [aux_sym_block_type_token2] = ACTIONS(9),
    [aux_sym_block_type_token3] = ACTIONS(9),
    [aux_sym_block_type_token4] = ACTIONS(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_const_block_repeat1, 2, 0, 0),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_const_block_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_const_block_repeat1, 2, 0, 0),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_const_block_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_const_block, 3, 0, 1),
  [38] = {.entry = {.count = 1, .reusable = false}}, SHIFT(6),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_const_block, 3, 0, 1),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_const_block, 4, 0, 1),
  [46] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_const_block, 4, 0, 1),
  [50] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text_block, 4, 0, 1),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 4, 0, 1),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text_block, 5, 0, 1),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 1),
  ...
  [72] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_block_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_block_repeat1, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_block_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  ...
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 1, 0, 0),
  ...
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func, 4, 0, 2),
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_type, 1, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_pory(void) {
